...
//				System.out.println("this is password before decryption" + em1.getERS_PASSWORD());
...
//				}
			...
			if (em.getUSER_ROLE_ID_FK() == 1) {
				...
				RequestHelper.loggy.info(em.getERS_USERNAME() + " overrided there temporary password");
		...
		if (request.getParameter("password") != null) {
			...
			// }
			em.setERS_PASSWORD(password);
			RequestHelper.loggy.info(em.getERS_USERNAME() + "  updated there password");
			...
			RequestHelper.loggy.info(em.getERS_USERNAME() + "  updated there first name");
			...
			RequestHelper.loggy.info(em.getERS_USERNAME() + "  updated there last name");
		} else if (request.getParameter("email") != null) {
			System.out.println("This is email change" + request.getParameter("email"));
			String email = request.getParameter("email");
			em.setUSER_EMAIL(email);
			RequestHelper.loggy.info(em.getERS_USERNAME() + "  updated there email");
		}
